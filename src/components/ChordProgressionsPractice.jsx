            ...
            <div className="h-12 flex flex-col items-center gap-1">
              {flashGreen ? (
                <div className="text-green-400 text-2xl font-bold flex items-center gap-2">
                  ...
                  <span className="music-notation"><Notation text={displayNotation(currentChordLabel)} /></span> (<span className="music-notation whitespace-nowrap">{currentNoteNames?.map((n, i) => <span key={i}>{i > 0 && '–'}<Notation text={displayNotation(n)} /></span>)}</span>)
                </div>
              ) : revealed ? (
                <div className="text-yellow-400 text-2xl font-bold flex items-center gap-2">
                  ...
                  Answer: <span className="music-notation"><Notation text={displayNotation(currentChordLabel)} /></span> (<span className="music-notation whitespace-nowrap">{currentNoteNames?.map((n, i) => <span key={i}>{i > 0 && '–'}<Notation text={displayNotation(n)} /></span>)}</span>)
                </div>
              ) : (
